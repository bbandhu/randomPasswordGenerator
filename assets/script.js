...
function showPromptForLowerCase(){
  const confirmed = window.confirm('Enter your password Criteria- do you want to include lowercase?');
...
function showPromptForUpperCase(){
  const confirmed = window.confirm('Enter your password Criteria- do you to include upperCase?');
  //console.log(confirmed);
  return confirmed;
}
...
function showPromptForNumerics(){
  const confirmed = window.confirm('Enter your password Criteria- do you to include numerics?');
  //console.log(confirmed);
  return confirmed;
}
...
function showPromptForSpecialCharacters(){
  const confirmed = window.confirm('Enter your password Criteria- do you to include Specialcharacters?');
  //console.log(confirmed);
  return confirmed;
}
...
if (passwordLength < 8 || passwordLength > 128) {
 ...
 if (!lowerCase && !upperCase && !numeric && !includeSpecial) {
